...
CATEGORICAL_MAP_DIR = os.path.join(ASSETS_DIR, "categorical_maps")
...
subregion_map_color_scheme_options = {
    SOLUTIONS.VEGETATION_MANAGEMENT.value: [
        ...
        {
            "label": "Risk (Customer Interruptions, Category)", 
        ...
        {
            "label": "Customers Affected (Adjusted) [Category]", 
        ...
        {
            "label": "Probability of Outage (%, Category)", 

...
colors = anyconfig.load(os.path.join(basepath, 'aesthetics.yml'))
...
def generate_map(solution, aoj, region, asset_id, map_color_scheme):
    """
...
def inject_callbacks(app):
    ...
    def update_map(solution, map_color_scheme, asset_id, region, aoj):

...
const BarGraphScenario = ({ data, xAxisKey, title, height, barKeys, xAxisLabel, customTickFormatter, showPercentage, hideLabels, yAxisWidth, valueLabelPosition = "outside", valueLabelOffset = 5, rightMargin = 50, maxBarSize, layout = "vertical" }) => {
...
export default BarGraphScenario